    ...
    return (
        <div className={styles.container}>
            <div className={styles.halfNav}>
                ...
                <Link className={styles.navlink} to="/home" > Practice arena </Link>
                <Link className={styles.navlink} to="/classroom" > classroom </Link>
                <Link className={styles.navlink} to="/jobs" > view jobs </Link>
            </div>
            <div className={styles.halfNav}>
                <span>
